...
const FRONTEND_URL = process.env.FRONTEND_URL || 'https://tax-sandbox-game-cjsd.vercel.app';
const BACKEND_URL = process.env.BACKEND_URL || 'https://tax-sandbox-game.onrender.com';
